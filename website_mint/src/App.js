...
const GGaddress = "0xbf8cC4D9bf5A0ca4503Be01C4DBCe6638b96A3A6";
  ...
  return (
    <div className="App">
      <div className="container">
        ...
        {error && <p>{error}</p>}
        <h1>Mint a Eyes NFT !</h1>
        <p className="count">{data.totalSupply} / 10 </p>
        <p className="cost">Each Eyes NFT cost {data.cost / 10**18} eth (excluding gas fees)</p>
        <button onClick={mint}>BUY one Eyes NFT</button>
      </div>
    </div>
  );
}
